...
| `compress`                 | Enable or disable HTTP compression                                                                                                                                                                                                                                                                                                                                                      | `false`                                                  |
...
| `heartbeat_interval`       | interval between heartbeats (useful with some proxies, and old browsers), set to `0s` to disable                                                                                                                                                                                                                                                                                         | `5s`                                                     |
...
| `log_format`               | the log format, can be `JSON`, `FLUENTD` or `TEXT`                                                                                                                                                                                                                                                                                                                                       | `TEXT`                                                   |
...
| `metrics_addr`             | the address to listen on                                                                                                                                                                                                                                                                                                                                                                 | `127.0.0.1:3002`                                                  |
...
| `write_timeout`            | maximum duration before timing out writes of the response, set to `0s` to disable                                                                                                                                                                                                                                                                                                        | `60s`                                                    |
